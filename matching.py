...
def do(name, crossrefDF):
    ...
    # %%
    finaldf = result[1]
    #finalDF = finaldf[["DOI", "Unique affiliations", "light affiliations" ,'# Authors','# Unique affiliations', '# Matched orgs','Candidates for matching', 'Matched openAIRE names', 'Similarity score']]
