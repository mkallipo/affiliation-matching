...
def clean_string_lucky(input_string):
    ...
    #     'universiteitsmuseum', 'panepistimioupoli'
    # }
...
#     result = re.sub(r'instit\w*', 'instit', result, flags=re.IGNORECASE)
...
#     result = re.sub(r'panepist\w*', 'univer', result, flags=re.IGNORECASE)
