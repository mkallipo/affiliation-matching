...
2. In the next phase the goal is to __shorten the strings__: the average length of a string of an affiliation is ~90  and this string often contains dispensable details. See for example the affiliations A1 (length 189), A2 (length 395), A3 (length 85) above. 
The task now is to __extract only the essential information__ from each affiliation string.
