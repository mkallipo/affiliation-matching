...
&nbsp;&nbsp;&nbsp;&nbsp We focus on these cases and filter the openAIRE organizations to those that are __not__ under the _Rest_ label. This significantly reduces the dataset we need to search.
